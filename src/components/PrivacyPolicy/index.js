const PrivacyPolicy = () => {
  return (
    <div style={{ textAlign: "center" }}>
      <h1>Privacy Policy for Saray Istanbul</h1>
      <p>
        At Saray Istanbul, one of our main priorities is the privacy of our
        visitors. This Privacy Policy document contains types of information
        that is collected and recorded by Saray Istanbul and how we use it.
      </p>
      <p>
      ...
      <h2>Log Files</h2>
      <p>
        Saray Istanbul follows a standard procedure of using log files. These
        files log visitors when they use app. The information collected by log
        files include internet protocol (IP) addresses, browser type, Internet
        Service Provider (ISP), date and time stamp, referring/exit pages, and
        possibly the number of clicks. These are not linked to any information
        that is personally identifiable. The purpose of the information is for
        analyzing trends, administering the app, tracking users' movement on the
        app, and gathering demographic information.
      </p>
      ...
      <p>
        ...
        advertising partners of Saray Istanbul.
      </p>
      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Beacons that are used in their respective advertisements
        and links that appear on Saray Istanbul. They automatically receive your
      ...
      <p>
        Note that Saray Istanbul has no access to or control over these cookies
        that are used by third-party advertisers.
      </p>
      <h2>Third Party Privacy Policies</h2>
      <p>
        Saray Istanbul's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        Saray Istanbul does not knowingly collect any Personal Identifiable
      ...
      <p>
        ...
        and/or collect in Saray Istanbul. This policy is not applicable to any
