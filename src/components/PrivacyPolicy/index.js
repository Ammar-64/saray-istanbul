const PrivacyPolicy = () => {
  return (
    <div style={{ textAlign: "center" }}>
      <h1>Privacy Policy for Akar Turk</h1>
      <p>
        At Akar Turk, one of our main priorities is the privacy of our visitors.
        This Privacy Policy document contains types of information that is
        collected and recorded by Akar Turk and how we use it.
      </p>
      <p>
      ...
      <h2>Log Files</h2>
      <p>
        Akar Turk follows a standard procedure of using log files. These files
      ...
      <p>
        ...
        advertising partners of Akar Turk.
      </p>
      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Beacons that are used in their respective advertisements
        and links that appear on Akar Turk. They automatically receive your IP
        address when this occurs. These technologies are used to measure the
        effectiveness of their advertising campaigns and/or to personalize the
        advertising content that you see on this app or other apps or websites.
      </p>
      <p>
        Note that Akar Turk has no access to or control over these cookies that
        are used by third-party advertisers.
      </p>
      <h2>Third Party Privacy Policies</h2>
      <p>
        Akar Turk's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        Akar Turk does not knowingly collect any Personal Identifiable
      ...
      <p>
        ...
        and/or collect in Akar Turk. This policy is not applicable to any
